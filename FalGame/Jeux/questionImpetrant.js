const questions = [
    ...
    },
    {
        ...
        hints: [
            ...
            "Indice 2 : Basée à la faculté des sciences de Nancy cette association porte un nom qui reflète son engagement dans la promotion des sciences parmi les étudiants.",
...
function showHint() {
    if (currentHint < questions[currentQuestion].hints.length) {
        ...
        alert("Tous les indices ont été montrés.");
    }
}
...
function checkAnswer() {
    ...
    if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
        ...
        document.getElementById('result').innerText = `Faux ! La bonne réponse était : ${correctAnswer}.`;
    }
}
...
document.getElementById('next-btn').addEventListener('click', () => {
    ...
    if (currentQuestion < questions.length) {
        displayQuestion();
         ...
         // Fin du quiz : on masque les sections/boutons et affiche le bouton "Accueil"
        document.getElementById('question-section').innerHTML = "<p>Le quiz est terminé !</p>";
        document.getElementById('hints').innerHTML = '';
        document.getElementById('result').innerText = '';
